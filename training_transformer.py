...
if __name__ == '__main__':
    ...
    args.dataset_path = r"/content/drive/MyDrive/NewProject/images"
    checkpoint_dir = r"/content/drive/MyDrive/NewProject/VQGAN/checkpoints"
    checkpoint_file = "vqgan_epoch_41.pt"
    args.checkpoint_path = os.path.join(checkpoint_dir, checkpoint_file)
